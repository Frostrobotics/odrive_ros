...
export PYTHONPATH
This assumes installation in Linux and catkin; other installations require slightly different filepaths and commands. Just look around if you are not sure.
